...
export function LayoutBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new Layout(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "ArktsFrontend/entry/src/main/ets/pages/Layout.ets", line: 16, col: 3 });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                                        ...
                                        this.ifElseBranchUpdateFunction(0, () => {
                                            {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    if (isInitialRender) {
                                                        let componentCall = new HomePage(this, {}, undefined, elmtId, () => { }, { page: "ArktsFrontend/entry/src/main/ets/pages/Layout.ets", line: 52, col: 15 });
                                        ...
                                        this.ifElseBranchUpdateFunction(1, () => {
                                            {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    if (isInitialRender) {
                                                        let componentCall = new RecipePage(this, {}, undefined, elmtId, () => { }, { page: "ArktsFrontend/entry/src/main/ets/pages/Layout.ets", line: 54, col: 15 });
                                                        ViewPU.create(componentCall);
                                                        let paramsLambda = () => {
                                                            return {};
                                                        };
                                        ...
                                        this.ifElseBranchUpdateFunction(2, () => {
                                            {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    if (isInitialRender) {
                                                        let componentCall = new MarketPage(this, {}, undefined, elmtId, () => { }, { page: "ArktsFrontend/entry/src/main/ets/pages/Layout.ets", line: 56, col: 15 });
                                                        ViewPU.create(componentCall);
                                                        let paramsLambda = () => {
                                                            return {};
                                                        };
                                        ...
                                        this.ifElseBranchUpdateFunction(3, () => {
                                            {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    if (isInitialRender) {
                                                        let componentCall = new UserPage(this, {}, undefined, elmtId, () => { }, { page: "ArktsFrontend/entry/src/main/ets/pages/Layout.ets", line: 58, col: 15 });
                                                        ViewPU.create(componentCall);
                                                        let paramsLambda = () => {
                                                            return {};
                                                        };
                ...
                ForEach.pop();
                Tabs.pop();
            }, { moduleName: "entry", pagePath: "ArktsFrontend/entry/src/main/ets/pages/Layout" });
